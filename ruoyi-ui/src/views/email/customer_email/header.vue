                            ...
                            <div>
                                <span>
                                    <span class="okki-icon-wrap tool-bar-icon-item">​<svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            fill="currentColor" class="okki-svg-icon">
                                            <path
            ...
            <div class="mail-toolbar-right">
                ...
                <div class="mail-paging tool-bar-paging">
                    ...
                    <div class="quick-jumper">
                        <input :max="totalPages" class="mail-paging-input" v-model="currentPage" @blur="handlePageInputBlur"
        ...
        <div class="top-block">
            <div class="multi-select" style="display: none;">
                <div class="multi-select-content">
                    <span>已选择此页面上所有 <span class="num">  20  </span> 封邮件</span> ， <a class="all">选择全部 <a class="num">  1121 
                        </a> 封邮件</a>
                </div>
            </div>
            <!---->
                                ...
                                <div class="mail-list-header-tool-wrapper">
                                    <div class="mm-tabs mm-tabs__top mm-tabs__align-left mail-list-toggle-tab header-tab">
                                        ...
                                        <div class="mm-tabs-content">
                                            <div id="pane-all" aria-hidden="false" aria-labelledby="tab-all"
                                                class="mm-tab-pane" role="tabpanel"></div>
