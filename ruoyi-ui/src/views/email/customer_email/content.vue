                                                    ...
                                                    <div class="mm-tabs-item mm-tabs-item__top mm-tabs-item--active"
                                                        ...
                                                        aria-selected="true" tabindex="0" refinfor="true"><span
                                                            class="mm-tooltip"><span class="mm-tooltip-trigger">全部<span
                                                                    class="mail-tab-unread">(32)</span></span><!----></span><!---->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="mail-list-scroll-container">
                                <ul class="grouped-list-container bordered mail-grouped-list">
                                    ...
                                    <li class="grouped-list-item yesterday">
                                        <h2 class="grouped-list-item-title"><span class="time-title">昨天</span><span
                                                class="mail-count">
                                                (&nbsp;1&nbsp;封) </span></h2>
                                        <ul class="plain-list-container bordered">
                                            <li class="plain-list-item" @click="onShowLabel">
                                    ...
                                    <li class="grouped-list-item month">
                                        <h2 class="grouped-list-item-title"><span class="time-title">本月</span><span
                                                class="mail-count">
                                                (&nbsp;2&nbsp;封) </span></h2>
                                        <ul class="plain-list-container bordered">
                                                    ...
                                                    <div class="mail-item-container mail-list-item-wrapper" draggable="true"
                                                        ...
                                                        <div class="flex-grow flex-shrink-0">
                                                            <div class="mail-list-item-content">
                                                                ...
                                                                <div class="mail-list-item-overview-content">
                                                                    <div class="con-wrap"><!----><span
                                                                            class="subject-summary-wrap"><span
                                                                                title="Merry Christmas"
                                                                                class="subject ellipsis">Merry
                                                                                Christmas</span><span
                                                                                class="summary summary-content ellipsis"><span
                                                                                    class="concat-line">&nbsp;-&nbsp;</span><span
                                                                                    ...
                                                                                    class="ellipsis">Dear, &nbsp; &nbsp;
                                                                                    &nbsp; &nbsp;Good
                                                                                    morning. I haven’t sent you an email for
                                                                                    a long time, and I
                                                                                    haven’t received your email. Christmas
                                                                                    is coming next week.
                                                                                    &nbsp; &nbsp; &nbsp; &nbsp;Are you
                                                                                    preparing a lot of gifts
                                                                                    for Christmas? How do you spend this
                                                                                    happy time? What about
                                                                                    the festivals?I wish you a Merry
                                                                                    Christmas in advance and
                                                            ...
                                                            <div class="mail-list-item-content">
                                                                ...
                                                                <div class="mail-list-item-overview-content">
                                                                    <div class="con-wrap"><!----><span
                                                                            class="subject-summary-wrap"><span
                                                                                title="connect"
                                                                                class="subject ellipsis">connect</span><span
                                                                                class="summary summary-content ellipsis"><span
                                                                                    class="concat-line">&nbsp;-&nbsp;</span><span
                                                                                    ...
                                                                                    class="ellipsis">Hi Dear &nbsp; &nbsp;
                                                                                    &nbsp; I didn’t send
                                                                                    you an email last week and didn’t see
                                                                                    your reply. Are you
                                                                                    working on any new projects recently?Is
                                                                                    there anything I can
                                                                                    do to help you? &nbsp; If you need help,
                                                                                    please feel free to
                                    ...
                                    <li class="grouped-list-item 2023-11">
                                        <h2 class="grouped-list-item-title"><span class="time-title">2023年11月</span><span
                                                class="mail-count">
                                                (&nbsp;2&nbsp;封) </span></h2>
                                        <ul class="plain-list-container bordered">
                                            <li class="plain-list-item">
                                                                    ...
                                                                    <div class="con-wrap"><!----><span
                                                                            class="subject-summary-wrap"><span
                                                                                ...
                                                                                class="summary summary-content ellipsis"><span
                                                                                    ...
                                                                                    class="ellipsis">Hi&nbsp; Dear &nbsp;
                                                                                    &nbsp; &nbsp;Good
                                                                                    evening!I still haven't seen the email
                                                                                    you replied to me. If
                                                                                    you have a new project and need to
                                                                                    purchase products, &nbsp;
                                                                                    &nbsp; &nbsp; &nbsp;I hope I can help
                                                                                    you. You can also add
                                                                                    my whastsapp and send me messages at any
                                                                                    time. I look
                                                                    ...
                                                                    <div class="con-wrap"><!----><span
                                                                            class="subject-summary-wrap"><span
                                                                                ...
                                                                                class="summary summary-content ellipsis"><span
                                                                                    ...
                                                                                    class="ellipsis">Dear Good day.
                                                                                    Appreciate for reading this
                                                                                    letter at first. I am your sales
                                                                                    &nbsp;representative Luffy
                                                                                    from Hi-tech (HK) Electronics Co.,Ltd
                                                                                    and I would like to
                                                                                    introduce some of our company's latest
                                                                                    chip products and
                                                                                    services. Our company has always been
                                                                                    committed to providing
                                                                                    customers with high-quality IC chip
                                                                                    products and excellent
                                                                                    after-sales services.We have been highly
                                                                                    trusted and praised
                                                                                    by customers in past ten years. Our
                                                                                    products cover various
                                                                                    types of chips, including
                                                                                    JST,MOXLE,ST,XILINX,Fuse
                                                                                    connectors,relays,etc.,which with high
                                                                                    performance, low
                                                                                    power consumption, stability,
                                                                                    reliability.In addition to
                                                                                    electronic components, we can also help
                                                                                    our customers with
                                                                                    PCB design and production. We can meet
                                                                                    customers' needs in
                                                                                    various application scenarios. If you
                                                                                    have any inquiry or
                                                                                    questions in more detail, please do not
                                                                                    hesitate to contact
                                                                                    us. We looking forward to your feedback.
                                                                                    regards Sincerely,
                                                                                    Luffy&nbsp; ———————————————————————————
                                                                                    Hi-tech&nbsp;(HK)&nbsp;Electronics&nbsp;Co.,Ltd
                                                                                    whatsapp:+86-3679752170
                                                                                    Wechat:yydbb827</span></span></span>
                                                                    </div>
                                                                </div>
                                                                <div></div>
