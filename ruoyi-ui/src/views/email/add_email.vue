                                        ...
                                        <span class="mm-form-field-children">
                                            <span class="mm-input">
                                              ...
                                              <!---->
                                                ...
                                                <span class="okki-icon-wrap work-email-tip">​
                                                    ...
                                                    <svg
                                                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" aria-hidden="true" class="okki-svg-icon" fill="currentColor">
                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M4 12a8 8 0 1116 0 8 8 0 01-16 0zm8-10C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1.2 4.75a1.25 1.25 0 11-2.5 0 1.25 1.25 0 012.5 0zM11.2 9a1 1 0 100 2v5h-.9a1 1 0 100 2h3.5a1 1 0 100-2h-.6v-6a1 1 0 00-1-1h-1z"></path>
                                                    </svg>
                                                </span>
                                            </span>
                      <!---->
                                                ...
                                                <span class="mm-form-field-children">
                                                    ...
                                                    <div class="mm-radio-group">
                                                        <label class="mm-radio">
                                                            <input show="function(){return!0}" name="mm-radio-group-60" type="radio" value="imap" checked="">
                                                            ...
                                                            <label class="mm-radio">
                                                                <input show="function(){return!0}" name="mm-radio-group-60" type="radio" value="pop">
                                                                    <span class="mm-radio-faux">
                                                                        <span class="mm-radio-input"></span>
                                                                ...
                                                                <label class="mm-radio">
                                                                    <input show="function(e){return e.setting.multi_user_name_flag!==We.CUSTOM}" name="mm-radio-group-60" type="radio" value="exchange">
                                                                        <span class="mm-radio-faux">
                                                                            <span class="mm-radio-input"></span>
                                                                                    ...
                                                                                    <span class="mm-form-field-children">
                                                                                        <div class="mm-radio-group">
                                                                                            <label class="mm-radio">
                                                                                                ...
                                                                                                <label class="mm-radio">
                                                                                                    <input name="mm-radio-group-61" type="radio" value="0">
                                                                                                        <span class="mm-radio-faux">
                                                                                                            <span class="mm-radio-input"></span>
                                                                                            ...
                                                                                            <span class="mm-form-field-children">
                                                                                                <span class="mm-select">
                                                                                                    <div class="mm-selector--single mm-selector" tabindex="0">
                                                                                                        <!---->
                                                                                                        <div class="mm-selector-rendered">
                                                                                                            <span title="HTTP代理" class="mm-selector-selected-value" style="opacity: 1;">HTTP代理</span>
                                                                                                          <!---->
                                                                                                        </div>
                                                                                                      <!---->
                                                                                                        <span class="mm-selector-suffix-icon">
                  ...
                  <div class="mm-form-field mail-bind-radio-field">
                    ...
                    <div class="mm-form-field-control">
                                                                                                            <span class="mm-form-field-children">
                                                                                                                <div class="mm-radio-group">
                                                                                                                    <label class="mm-radio">
                                                                                                                        <input name="mm-radio-group-62" type="radio" value="1" checked="">
                                                                                                                            <span class="mm-radio-faux">
                                                                                                                                <span class="mm-radio-input"></span>
                                                                                                                                <span class="mm-radio-label">开启</span>
                                                                                                                            </span>
                                                                                                                        ...
                                                                                                                        <label class="mm-radio">
                                                                                                                            <input name="mm-radio-group-62" type="radio" value="0">
                                                                                                                                <span class="mm-radio-faux">
                                                                                                                                    <span class="mm-radio-input"></span>
                                                                                                                                    <span class="mm-radio-label">关闭</span>
                                                                                                                                </span>
