		...
		<div class="steps">
			...
			<ul class="c-form-inputItem">
				<li class="flex items-center">
					...
					><span class="mm-select user-mail-list mx-2"
						><div
							class="mm-selector--single mm-selector"
							tabindex="0">
							<span class="mm-selector__placeholder"
								>选择目标邮箱</span
							>
							<div class="mm-selector-rendered"></div>
						...
						<!----></span
					>
					<div class="mm-tree-select folder-selector">
						<div
							class="mm-selector--single mm-selector"
							tabindex="0">
							<span class="mm-selector__placeholder"
					...
					<div class="mx-2 py-2 inline-block">
						...
						><span class="e-file-value block"
							><span style="color: red"
								>暂时只支持pst、eml文件或者是eml文件组成的zip压缩包，不超过2G</span
							><!----></span
						>
					</div>
				</li>
				<li class="pt-2">
					...
					<div class="mx-2 py-2 inline-block">
						<div>
							<button
								class="disabled m-btn"
								type="button">
								<span>确认上传</span></button
							><span class="e-upload-tips"></span
							><!---->
						</div>
				...
				<table>
									...
									><span class="mm-tooltip-trigger"
										><svg
											...
											<path
												fill-rule="evenodd"
												clip-rule="evenodd"
												d="M4 12a8 8 0 1116 0 8 8 0 01-16 0zm8-10C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm1.2 4.75a1.25 1.25 0 11-2.5 0 1.25 1.25 0 012.5 0zM11.2 9a1 1 0 100 2v5h-.9a1 1 0 100 2h3.5a1 1 0 100-2h-.6v-6a1 1 0 00-1-1h-1z"></path></svg></span
									><!----></span
								>
							</th>
					...
					<tbody>
						<tr>
							<td>
								<p
									title="A16Z合伙人：5G来了，我们能干啥？-2019-10-11.eml"
									class="ellipsis">
							...
							<td><p>0</p></td>
							<td><p>——</p></td>
							<td><p>2023-12-22 15:16:59</p></td>
						</tr>
						<tr>
							<td>
								<p
									title="“火箭蛋”又来袭蛋价后期仍有上涨可能-2019-07-17.eml"
									class="ellipsis">
							...
							<td><p>0</p></td>
							<td><p>——</p></td>
							<td><p>2023-07-26 17:49:45</p></td>
						</tr>
						<tr>
							<td>
								<p
									title="“手铐打不开，民警求助消防”上热搜：119吗，我是110-2019-07-17.eml"
									class="ellipsis">
						...
						<tr>
							...
							<td><p>0</p></td>
							<td><p>——</p></td>
							<td><p>2023-07-26 17:46:34</p></td>
						</tr>
						<tr>
							<td>
								<p
									title="阿斯顿·马丁全新跑车将于7月19日国内首发-2019-07-17.eml"
									class="ellipsis">
							...
							<td><p>0</p></td>
							<td><p>——</p></td>
							<td><p>2023-07-26 17:45:50</p></td>
						</tr>
						<tr>
							<td>
								<p
									title="70城房价涨幅回落下半年资金压力或迫使房企降价-2019-07-17.eml"
									class="ellipsis">
			...
			<div class="mail-page">
				<ul class="mm-pagination mm-pagination__right">
					<li class="disabled mm-pagination-prev">
						<svg
							class="mm-icon mm-icon-chevronleft"
							viewBox="0 0 24 24"
							name="chevronleft"
							xmlns="XMLNS"
							fill="currentColor"
							...
							<path
								d="M15.8 22l-9.6-9.4c-.3-.3-.3-.8 0-1.1l9.6-9.4c.3-.3.7-.3 1 0l1 1c.3.3.3.7 0 1l-7.6 7.4c-.3.3-.3.8 0 1.1l7.5 7.4c.3.3.3.7 0 1l-1 1c-.2.2-.6.2-.9 0z"></path>
						</svg>
					</li>
					<li>
					...
					<li class="disabled mm-pagination-next">
						<svg
							class="mm-icon mm-icon-chevronright"
							viewBox="0 0 24 24"
							name="chevronright"
							xmlns="XMLNS"
							fill="currentColor"
							style="height: 0.875rem; width: 0.875rem">
							<path
								d="M8.3 2l9.5 9.5c.3.3.3.7 0 1L8.3 22c-.3.2-.8.2-1.1 0l-1-1c-.2-.3-.2-.8 0-1.1l7.6-7.4c.2-.3.2-.7 0-1L6.3 4.1C6 3.8 6 3.3 6.3 3l1-1c.3-.2.7-.2 1 0z"></path>
						</svg>
					</li>
				</ul>
			</div>
