<template>
  <div class="mm-split-pane mm-split-pane__right" style="left: 12.2835%;">
    <div class="page-mail-list layout-extraSidebar-content" style="background-color: white;">
                            ...
                            <div class="mail-toolbar-wrapper" v-if="shouldDisplayFirstToolbar">
                              ...
                              <div class="mail-toolbar-right">
                                ...
                                <div class="mail-paging tool-bar-paging">
                                  <span class="total-count ellipsis" title="共 955 封">共 955 封</span>
                                  <div class="quick-jumper">
                                    <input max="48" class="mail-paging-input">
                                    <span class="mail-paging-slash"> / </span>
                                    <span class="page-unit">48 &nbsp;页</span>
                                  </div>
                                ...
                                <span class="mm-tooltip mail-toolbar-btn-item">
                                  <span class="mm-tooltip-trigger">
                                    <a href="/pro/mail/config/conventional" class="mail-toolbar-btn-item noright" tag="div">
                              ...
                              <div class="mail-drop-menu-wrapper" style="width: 220px; top: 39px; left: 242px; display: none;">
                                <ul class="mail-drop-menu" style="">
                                  <!---->
                                  <li class="mail-drop-menu-item DROPMENU_46728_ITEM_0">
                                    <!---->
                                    <span class="mail-drop-menu-text ellipsis">
                                      <!---->
                                      <span title="标为已读" class="">标为已读</span>
                                    </span>
                                    <span>
                                      <!---->
                                    </span>
                                  </li>
                                  <li class="mail-drop-menu-item DROPMENU_46728_ITEM_1">
                                    <!---->
                                    <span class="mail-drop-menu-text ellipsis">
                                      <!---->
                                  ...
                                  <li class="mail-drop-menu-item DROPMENU_46728_ITEM_2">
                                ...
                                <!---->
														...
														<div class="mail-toolbar-wrapper" v-else-if="shouldDisplaySecondToolbar">
															<div class="mail-toolbar-left">
																<span class="mail-toolbar-btn-item">
																	<label class="mm-checkbox">
                                    ...
                                    <!---->
																...
																<span class="mm-tooltip mail-toolbar-btn-item" @click="refresh">
																	<span class="mm-tooltip-trigger">
																		<span>
																			<span class="okki-icon-wrap tool-bar-icon-item">​<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" class="okki-svg-icon" fill="currentColor">
...
export default {
  data() {
    return {
      ...
      currentEmailType: '',
      selectAll: false,
      parentCheckboxState: 'none',
      showFirstToolbar: false,
  ...
  computed: {
    ...
    allEmails() {
      let emails = [];
      this.localEmailList.forEach(group => {
        for(let date in group) {
          emails = emails.concat(group[date]);
        }
      });
      return emails;
    },
    selectedCount() {
      return this.allEmails.filter(email => email.selected).length;
    },
    shouldDisplayFirstToolbar() {
      return this.selectedCount === 1;
    },
    shouldDisplaySecondToolbar() {
      return this.selectedCount !== 1;
    }
  },
  ...
  methods: {
    ...
    isAnyEmailSelected() {
      return this.localEmailList.some(dateGroup => {
        for (const date in dateGroup) {
          if (dateGroup[date].some(email => email.selected)) {
            return true;
          }
        }
        return false;
    ...
    toggleAll() {
      if (this.parentCheckboxState === 'all') {
        this.allEmails.forEach(email => email.selected = false);
      } else {
        this.allEmails.forEach(email => email.selected = true);
      }
    }
  }
}
